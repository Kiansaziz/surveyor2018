(function(){
    ...
    app.controller('dashboardController', function($scope, $http, toastr, filterFilter){
      ...
      $scope.dashboardKuesioner = function() {
        ...
        $http.post("../api/korwil/dashboard.php?type=kuesioner&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      ...
      $scope.dashboardCapaian = function() {
        ...
        $http.post("../api/korwil/dashboard.php?type=capaian&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      ...
      $scope.dashboardCapaianPercent = function() {
        ...
        $http.post("../api/korwil/dashboard.php?type=capaian_percent&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      ...
      $scope.dashboardJenisKelamin = function() {
        ...
        $http.post("../api/korwil/dashboard.php?type=jenis_kelamin&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      ...
      $scope.dashboardProfesi = function() {
        ...
        $http.post("../api/korwil/dashboard.php?type=profesi&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      ...
      $scope.dashboardProfesiLain = function() {
        ...
        $http.post("../api/korwil/dashboard.php?type=profesi_lain&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      ...
      $scope.dashboardUsia = function() {
        ...
        $http.post("../api/korwil/dashboard.php?type=usia&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      $scope.dashboardUsia();
      ...
      $scope.dashboardPendidikan = function() {
        ...
        $http.post("../api/korwil/dashboard.php?type=pendidikan&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
