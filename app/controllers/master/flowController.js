(function(){
    ...
    app.controller('flowController', function($scope, $http, toastr, filterFilter){
      ...
      $scope.filterChart = function(filter) {
        ...
        $http.post("../api/master/flow.php?type=filter",filter).then(onSuccess, onError);
      }
      ...
      var chartCapaian = function(wilayah, filter) {
        ...
        $http.post("../api/master/flow.php?type=capaian", filter).then(onSuccess, onError);
      }
      ...
      var chartCapaianPercent = function(wilayah, filter) {
        ...
        $http.post("../api/master/flow.php?type=capaian_percent", filter).then(onSuccess, onError);
      }
      ...
      var chartJenisKelamin = function(filter) {
        ...
        $http.post("../api/master/flow.php?type=jenis_kelamin", filter).then(onSuccess, onError);
      }
      ...
      var chartProfesi = function(filter) {
        ...
        $http.post("../api/master/flow.php?type=profesi", filter).then(onSuccess, onError);
      }
      ...
      var chartProfesiLain = function(filter) {
        ...
        $http.post("../api/master/flow.php?type=profesi_lain", filter).then(onSuccess, onError);
      }
      ...
      var chartUsia = function(filter) {
        ...
        $http.post("../api/master/flow.php?type=usia", filter).then(onSuccess, onError);
      }
      ...
      var chartPendidikan = function(filter) {
        ...
        $http.post("../api/master/flow.php?type=pendidikan", filter).then(onSuccess, onError);
      }
