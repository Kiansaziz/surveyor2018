(function(){
    ...
    app.controller('pesanController', function($scope, AuthService, $http, toastr){
      ...
      var khusus = function(){
        ...
        $http.post("../api/admin/pesan.php?type=dataPesanKhusus&token=" + JSON.parse(localStorage['_token']))
      ...
      var broadcast = function(){
        ...
        $http.post("../api/admin/pesan.php?type=dataPesanBroadcast&token=" + JSON.parse(localStorage['_token']))
        .then(onSuccess, onError);
      }
      broadcast();
      ...
      var users = function(){
        ...
        $http.post("../api/admin/user.php?type=dataUser")
        .then(onSuccess, onError);
      }
      users();
      ...
      $scope.addPesanKhusus = function(detail){
        ...
        $http.post('../api/admin/pesan.php?type=insertPesanKhusus', detail).success(function(response){
      ...
      $scope.addPesanBroadcast = function(detail){
        ...
        $http.post('../api/admin/pesan.php?type=insertPesanBroadcast', detail).success(function(response){
          if (response.status == 'success') {
            toastr.success(response.keterangan);
            broadcast();
          } else if (response.status != 'success') {
      ...
      $scope.deletePesan = function(detail, bagian, tabel){
        ...
        if (tanya !="0")
        {
          ...
          $http.post('../api/admin/pesan.php?type=delete', data).success(function(data){
